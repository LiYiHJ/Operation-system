...
def patch_types() -> None:
    ...
    backup = TYPES.with_suffix(".ts.bak_frontend_rebuild_import_entry_v1")
...
export interface ImportResult {""",
  ...
  transportStatus?: 'passed' | 'failed'""",
        "add confirm result audit fields",
    )
...
def patch_page() -> None:
    backup = PAGE.with_suffix(".tsx.bak_frontend_rebuild_import_entry_v1")
...
def main() -> None:
    ...
    print("Applied frontend rebuild import entry patch v1")
